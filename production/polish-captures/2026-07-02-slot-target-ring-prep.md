...
| Field | RGBA | Purpose |
|-------|------|---------|
| `BarBackground` | `0.22, 0.22, 0.24, 0.95` | Ring interior dim fill |
| `HpBandGreen` | `0.40, 0.85, 0.40, 1.00` | Damage band > 0.80 |
| `HpBandYellow` | `0.95, 0.85, 0.30, 1.00` | Damage band > 0.40 |
| `HpBandRed` | `0.90, 0.30, 0.25, 1.00` | Damage band ≤ 0.40 |
| `PreviewFill` | `1.00, 0.55, 0.10, 1.00` | Hover-projected damage arc |
| `MarkerRing` | `1.00, 1.00, 1.00, 0.85` | Legacy circle icon; ring outline base |
...
| `MainBarBg` | `0.05, 0.05, 0.06, 0.85` | Armor pill / chassis backdrop |
| `TargetHoverOutline` | `1.00, 0.85, 0.10, 1.00` | Hover-target outline highlight |
